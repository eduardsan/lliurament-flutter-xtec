...
class ImageStorageService {
  ...
  /// Saves an image from a generic source path to local storage.
  ...
  Future<String> saveImage(String sourcePath) async {
    ...
    // If the sourcePath is already within our managed storage, return it directly
  ...
  /// Useful for user-provided images in future iterations.
